...
export function validateTaskCompletionConsistency(tasks: AnyRecord[]): { failures: string[]; warnings: string[] } {
  ...
  for (const task of tasks) {
    ...
    const incompletePhases = (executionPhases as AnyRecord[]).filter(
