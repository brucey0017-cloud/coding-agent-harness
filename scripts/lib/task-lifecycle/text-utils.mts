...
export function appendProgressLog(
  content: string,
  { event, message, evidence, actor = "coordinator" }: { event: string; message?: string; evidence?: string; actor?: string },
): string {
...
export function markWalkthroughClosed(content: string): string {
